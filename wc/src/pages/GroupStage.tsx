...
export default function GroupStage() {
  ...
  function handleOpenThirdPlace() {
    if (!allGroupsDone) {
      setErrorMsg("Not all groups are finished!");
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 pt-40 pb-20 gap-7 opacity-0 animate-[fadeIn_0.4s_ease-out_forwards]">
              ...
              <Group
                ...
                teams={[
                  ...
                  },
                  {
                    name: "Switzerland",
                    flag:
                      "https://st2.depositphotos.com/1007997/5889/v/950/depositphotos_58894729-stock-illustration-switzerland-flag-vector.jpg",
                  },
                ]}
                isGroupFinished={handleGroupFinished}
              />
              <Group
                ...
                teams={[
                  ...
                  {
                    name: "Scotland",
                    flag: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Flag_of_Scotland.svg/330px-Flag_of_Scotland.svg.png",
                  },
                ]}
                isGroupFinished={handleGroupFinished}
              />
              <Group
                ...
                teams={[
                  ...
                  {
                    name: "Paraguay",
                    flag: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/Flag_of_Paraguay.svg/1200px-Flag_of_Paraguay.svg.png",
                  },
                  {
                    name: "Australia",
              ...
              <Group
                ...
                teams={[
                  {
                    name: "Belgium",
                    flag: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/Flag_of_Belgium.svg/1200px-Flag_of_Belgium.svg.png",
                  },
                  {
                    name: "Egypt",
                  ...
                  },
                  {
                    name: "Iran",
                    flag:
                      "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/Flag_of_Iran.svg/630px-Flag_of_Iran.svg.png",
                  },
                  {
                    name: "New Zealand",
                    flag:
                      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_dbTwtZ4Y0zI8zhVT9H-APzBOouDu_kxG-Q&s",
                  },
                ]}
                isGroupFinished={handleGroupFinished}
              />
              <Group
                ...
                teams={[
                  {
                    name: "Spain",
                    flag: "https://upload.wikimedia.org/wikipedia/en/thumb/9/9a/Flag_of_Spain.svg/2560px-Flag_of_Spain.svg.png",
                  },
                  {
                    name: "Cape Verde",
                    flag: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Flag_of_Cape_Verde.svg/1200px-Flag_of_Cape_Verde.svg.png",
                  },
                  {
                    name: "Saudi Arabia",
                    flag:
              ...
              <Group
                ...
                teams={[
                  ...
                  },
                  {
                    name: "Algeria",
                    flag:
                      "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Flag_of_Algeria_%28color_shades_variant%29.svg/2560px-Flag_of_Algeria_%28color_shades_variant%29.svg.png",
                  },
                  {
                    name: "Austria",
              ...
              <Group
                ...
                teams={[
                  ...
                  {
                    name: "Croatia",
                    flag: "https://cdn.britannica.com/06/6206-050-4A54E70D/Flag-Croatia.jpg",
                  },
                  {
                    name: "Ghana",
                ...
                isGroupFinished={handleGroupFinished}
              />
              <div className="flex flex-col absolute mt-20 top-0 items-center gap-2">
